...
mod tests {
    ...
    fn tax_year_boundaries() {
        assert_eq!(uk_tax_year("2024-04-05T23:59:59Z").unwrap(), "2023-2024");
        assert_eq!(uk_tax_year("2024-04-06T00:00:00Z").unwrap(), "2024-2025");
        assert_eq!(uk_tax_year("2025-01-01T12:00:00Z").unwrap(), "2024-2025");
        assert_eq!(uk_tax_year("2017-12-31T00:00:00Z").unwrap(), "2017-2018");
    }
    ...
    fn tax_event_type_round_trips() {
        for t in [
            ...
            assert_eq!(t.as_str().parse::<TaxEventType>().unwrap(), t);
        }
    }
