...
mod tests {
    ...
    #[test]
    fn parses_all_accepted_forms() -> Result<(), Box<dyn Error>> {
        for text in ["2024-2025", "2024-25", "2024/25", "2024"] {
            assert_eq!(TaxYear::parse(text)?.start_year, 2024, "{text}");
        }
    ...
    #[test]
    fn boundaries_are_6_april_to_5_april() -> Result<(), Box<dyn Error>> {
        let y = TaxYear::parse("2024-2025")?;
